namespace DataBase_First.Views.Academico.AsignacionDocentes
{
    partial class frm_AsignacionDocentes
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3 = new Label();
            cmb_Docente = new ComboBox();
            label2 = new Label();
            lst_Lista_Asignaciones = new ListBox();
            ...
            lblTitulo.Text = "ASIGNACIÓN DE DOCENTES A CURSOS";
            ...
            pnlContenedorCentral.Controls.Add(cmb_Docente);
            pnlContenedorCentral.Controls.Add(label2);
            pnlContenedorCentral.Controls.Add(lst_Lista_Asignaciones);
            ...
            // cmb_Docente
            // 
            cmb_Docente.BackColor = Color.WhiteSmoke;
            cmb_Docente.DropDownStyle = ComboBoxStyle.DropDownList;
            cmb_Docente.Enabled = false;
            cmb_Docente.FlatStyle = FlatStyle.Flat;
            cmb_Docente.Font = new Font("Segoe UI", 12F);
            cmb_Docente.Location = new Point(40, 65);
            cmb_Docente.Name = "cmb_Docente";
            cmb_Docente.Size = new Size(320, 29);
            cmb_Docente.TabIndex = 8;
            // 
            // label2
            // 
            ...
            // 
            lst_Lista_Asignaciones.BorderStyle = BorderStyle.None;
            lst_Lista_Asignaciones.Font = new Font("Segoe UI", 12F);
            lst_Lista_Asignaciones.ForeColor = Color.FromArgb(64, 64, 64);
            lst_Lista_Asignaciones.FormattingEnabled = true;
            lst_Lista_Asignaciones.ItemHeight = 21;
            lst_Lista_Asignaciones.Location = new Point(395, 40);
            lst_Lista_Asignaciones.Name = "lst_Lista_Asignaciones";
            lst_Lista_Asignaciones.Size = new Size(727, 357);
            lst_Lista_Asignaciones.TabIndex = 10;
            lst_Lista_Asignaciones.DoubleClick += lst_Lista_Asignaciones_DoubleClick;
            // 
